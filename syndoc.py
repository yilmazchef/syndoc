...
def update_all():
    ...
    for source_file in source_file_list:
        ...
        h4docx(docx_file, os.path.join(parent_dir, "header.png"),
               open(os.path.join(parent_dir, "header.txt"), 'r'))
        f4docx(docx_file, os.path.join(parent_dir, "footer.png"),
               open(os.path.join(parent_dir, "footer.txt"), 'r'))
